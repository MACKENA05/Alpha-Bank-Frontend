      ...
      <div className="flex justify-between items-center">
        ...
        {!isEditing ? (
          <button
            ...
            className="bg-emerald-500 text-white px-4 py-2 rounded-lg hover:bg-emerald-600 transition-all flex items-center"
          >
          ...
          <div className="flex gap-2">
            ...
            <button
              onClick={handleSave}
              disabled={isLoading}
              className="bg-emerald-500 text-white px-4 py-2 rounded-lg hover:bg-emerald-600 transition-all flex items-center disabled:opacity-50"
            >
            ...
            <div>
              ...
              <div className="flex items-center mt-2">
                ...
                <span className={`px-3 py-1 rounded-full text-sm font-semibold ${
                  user?.role === 'ADMIN' ? 'bg-emerald-600 text-white' : 'bg-emerald-100 text-emerald-800'
                }`}>
                  {user?.role}
                </span>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                {isEditing ? (
                  ...
                  <div className="w-full px-4 py-3 bg-gray-100 rounded-lg text-gray-800 font-medium">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                {isEditing ? (
                  ...
                  <div className="w-full px-4 py-3 bg-gray-100 rounded-lg text-gray-800 font-medium min-h-[84px]">
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div>
                ...
                <div className="w-full px-4 py-3 bg-gray-100 rounded-lg text-gray-800 font-mono">
                  #{user?.id}
                </div>
              </div>
              ...
              <div>
                ...
                <div className="w-full px-4 py-3 bg-gray-100 rounded-lg">
                  <span className={`px-3 py-1 rounded-full text-sm font-semibold ${
                    user?.isEnabled ? 'bg-emerald-100 text-emerald-800' : 'bg-red-100 text-red-800'
                  }`}>
